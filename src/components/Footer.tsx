...
export const Footer: FC = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#0B0B1E] pt-20">
      {/* Gradient Overlays */}
      <div className="absolute left-0 top-0 h-96 w-96 bg-purple-500/10 blur-[100px]" />
        ...
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                <h3 className="mb-4 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text font-semibold text-transparent">
                  {title}
                </h3>
