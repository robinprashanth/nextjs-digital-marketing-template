...
const TeamMemberCard: FC<TeamMemberCardProps> = ({
  ...
  <ScrollInView delay={index * 0.1} useInView={true} className="group relative">
...
export const TeamSectionSelect: FC = () => {
            ...
            <Button
              ...
              className={`rounded-full px-6 py-2 text-sm font-medium transition-colors ${
                selectedDepartment === dept
                  ...
                  : "bg-theme-primary-500/10 text-theme-primary-400 hover:bg-theme-primary-500/20"
              }`}
