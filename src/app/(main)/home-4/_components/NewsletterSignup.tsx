  ...
  return (
    <section className="relative py-24">
      <div className="container relative z-10 mx-auto max-w-7xl px-4">
        <div className="overflow-hidden rounded-[40px] bg-green-200 p-12 shadow-xl">
          <div className="mx-auto max-w-3xl text-center">
            {/* Header */}
            <FadeIn>
              <div className="mb-12">
                <h2 className="mb-4 text-6xl font-black tracking-tight text-gray-800">
                  STAY
              ...
              <form onSubmit={handleSubmit} className="relative">
                <div className="relative mx-auto max-w-xl">
                  <input
                    ...
                    className="w-full rounded-full bg-white py-4 pl-6 pr-36 text-gray-800 shadow-sm transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500"
                    required
                  />
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full bg-purple-600 px-6 py-2 text-sm font-semibold text-white transition-colors hover:bg-purple-700"
                  >
                ...
                <AnimatePresence>
                  {isSubmitted && (
                    ...
                    >
                      <div className="rounded-full bg-green-100 px-4 py-2 text-sm text-green-600">
