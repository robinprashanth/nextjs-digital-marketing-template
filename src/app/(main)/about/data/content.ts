...
export const companyTimeline = {
    ...
    description: "From our humble beginnings to becoming a global digital force, our journey has been defined by innovation, growth, and an unwavering commitment to client success.",
    milestones: [
      {
        year: "2014",
        title: "The Beginning",
        description: "Started as a small team of digital enthusiasts with a vision to transform the digital marketing landscape.",
        icon: "Rocket",
        stats: [
      ...
      },
      {
        ...
        description: "Opened our first international office and expanded our services to include comprehensive digital solutions.",
        icon: "Globe",
        stats: [
      ...
      },
      {
        ...
        description: "Launched our proprietary marketing analytics platform and established partnerships with major tech companies.",
        icon: "Lightbulb",
        stats: [
      ...
      },
      {
        year: "2022",
        title: "Global Impact",
        description: "Recognized as a leading digital marketing agency with a global presence and diverse client portfolio.",
        icon: "Trophy",
        stats: [
      ...
      },
      {
        ...
        description: "Pioneering AI-driven marketing solutions and expanding our reach to emerging markets worldwide.",
        icon: "Sparkles",
        stats: [
  ...
  export const missionValuesContent: MissionContent = {
    ...
    description: "Our mission is to empower businesses with innovative digital solutions that drive growth and create lasting impact.",
    mission: {
      title: "Our Mission",
      statement: "To revolutionize digital marketing through innovation and excellence, helping businesses thrive in the digital age while setting new standards for creativity, results, and client satisfaction.",
    },
    bottomCTA: {
      description: "Join us in our mission to transform the digital landscape and create meaningful impact for businesses worldwide.",
...
export const whyChooseUsContent: WhyChooseUsContent = {
    ...
    description: "We combine expertise, innovation, and proven methodologies to deliver exceptional results that drive your business forward in the digital age.",
    cta: {
  ...
  export const features: Feature[] = [
    {
      ...
      description: "Award-winning agency with a proven track record of delivering exceptional results across diverse industries.",
      gradient: "from-theme-primary-500 to-theme-ocean-600",
      stats: [
    ...
    },
    {
      icon: Rocket,
      title: "Innovation First",
      description: "Leveraging cutting-edge technologies and strategies to keep your business ahead of the digital curve.",
      gradient: "from-theme-rose-500 to-theme-primary-600",
      stats: [
  ...
  export const processContent: ProcessContent = {
    ...
    description: "A systematic approach to digital marketing that ensures consistent results and sustainable growth for your business.",
    cta: {
  ...
  export const clientSuccessContent = {
    ...
    description: "Discover how we've helped businesses achieve remarkable growth through innovative digital marketing strategies.",
    cta: {
  ...
  export const caseStudies: CaseStudy[] = [
    {
      ...
      description: "Transformed TechCorp's digital presence through an integrated marketing approach, combining SEO, content marketing, and targeted paid campaigns to dramatically increase qualified B2B leads.",
      ...
      testimonial: {
        ...
        content: "The strategic approach and deep technical expertise transformed our B2B marketing efforts. We've not only hit our ambitious growth targets but consistently exceeded them quarter after quarter.",
        rating: 5
      }
    },
    {
      ...
      description: "Implemented a comprehensive digital strategy that scaled GlobalTrade's e-commerce platform across multiple markets, optimizing conversion rates and customer acquisition costs.",
      ...
      testimonial: {
        ...
        content: "Their expertise in e-commerce and digital marketing has been instrumental in our international expansion. The results have exceeded our expectations, with our revenue more than doubling in just 18 months.",
        rating: 5
      }
    }
  ];
  ...
  export const awardsContent: AwardsContent = {
    ...
    description: "Industry recognition and accolades that reflect our commitment to excellence and innovation in digital marketing.",
    sections: {
