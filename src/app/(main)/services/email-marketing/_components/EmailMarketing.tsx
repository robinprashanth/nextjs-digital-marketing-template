              ...
              return (
                ...
                >
                  <div className="relative overflow-hidden rounded-3xl bg-gray-50 p-8 dark:bg-theme-neutral-800">
                    ...
                    {/* Hover Effect */}
                    <div className="absolute -bottom-20 -right-20 h-40 w-40 rounded-full bg-gradient-to-r from-theme-primary-500/10 to-theme-ocean-500/10 blur-xl transition-all duration-500 group-hover:scale-150" />
                  </div>
                </ScrollInView>
              );
            })}
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
            ...
            >
              <div className="relative h-[600px] overflow-hidden rounded-3xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-theme-primary-600/20 to-theme-ocean-600/20" />
              </div>
            </ScrollInView>
          </div>
        </div>
