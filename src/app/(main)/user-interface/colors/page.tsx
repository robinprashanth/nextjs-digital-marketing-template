...
const ColorSample: FC<ColorSampleProps> = ({ label, color, className }) => (
  <div className="flex flex-col gap-2">
    <div
      className={cn("h-16 w-full rounded-lg border border-border", className)}
    />
...
const ColorGradientExample: FC<{ className: string; title: string }> = ({
  className,
  title,
}) => <Button className={cn("w-full text-white", className)}>{title}</Button>;
      ...
      <ScrollInView>
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            A comprehensive guide to the color system used throughout the
            application.
          </p>
        </div>
      </ScrollInView>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="pop-card">
              ...
              <p className="text-muted-foreground">
                Example of card with hover effects and border.
              </p>
            </div>
